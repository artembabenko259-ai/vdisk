...
cl.exe /nologo /O2 /W3 ^
    /I "%WINFSP%inc" ^
    main.c disk_manager.c vram_allocator.c vdisk_util.c fs_memfs.c linux_shell.c block_disk.c qemu_linux.c save_disk.c accel.c bridge.c packages.c ^
    "%WINFSP%lib\winfsp-x64.lib" urlmon.lib shell32.lib virtdisk.lib ^
    /Fe:vdisk.exe ^
